...
export function SearchBar({
  ...
  const handleSelectProperty = (property) => {
    ...
    search.setSelectedPropertyCity(property.city ?? null);
    search.setSelectedPropertyState(property.state ?? null);
    search.setSelectedPropertyPostalCode(property.postalCode ?? null);
